...
if(isset($_GET['id'])){
	...
	$db->select(array('project.id_project', 'project.nama AS nama_project', 'project.foto','project.deskripsi','project.tgl', 'target','project.income','kategori.nama_kategori', 'user.nama', 'alamat','user.foto AS foto_user'));
	$db->where($where);
