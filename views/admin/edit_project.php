<div class="container-fluid mt1">
	<div class="row content">
		<form action="<?= baseurl('lib/actionEditProject.php?id_project=' . $project->id_project) ?>" method="POST">
			<legend>Form title</legend>
			<div class="input-field">
				<div class="form-group">
					<label class="control-label" for="">Nama Project</label>
					<span class="help-block"></span>
					<input type="text" class="form-control" name="nama" placeholder="Input field" value="<?= $project->nama ?>">
				</div>
			</div>
